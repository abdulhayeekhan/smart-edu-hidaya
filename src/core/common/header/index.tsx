...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <div className="header glass-panel border-0 shadow-none" style={{ position: 'sticky', top: 0, zIndex: 1000 }}>
        {/* Logo */}
        <div
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="pe-1 ms-1">
                <div className="dropdown">
                  <Link
                    to="#"
                    className="btn btn-outline-light bg-transparent d-flex align-items-center me-3 p-2 border-0"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    <i className="ti ti-world fs-5 me-2" style={{ color: '#D4AF37' }}></i>
                    <span className="fw-bold" style={{ color: '#ffffff' }}>
                      {i18n.language === 'ar' ? 'العربية' : 'English'}
                    </span>
                    <i className="ti ti-chevron-down ms-1" style={{ color: '#ffffff', fontSize: '12px' }}></i>
                  </Link>
                  <div className="dropdown-menu dropdown-menu-right">
                    <Link
                      to="#"
                      className={`dropdown-item d-flex align-items-center ${i18n.language === 'en' ? 'active' : ''}`}
                      onClick={() => {
                    ...
                    <Link
                      to="#"
                      className={`dropdown-item d-flex align-items-center ${i18n.language === 'ar' ? 'active' : ''}`}
                      onClick={() => {
