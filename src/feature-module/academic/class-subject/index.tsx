...
import { GetSubjects, Subject, AddSubject, GetSubject, UpdateSubject, DeleteSubject } from '../../../store/apps/subjects'
            ...
            <div className="modal-content">
              ...
              <form onSubmit={handleSave}>
                <div className="modal-body">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="mb-3">
                        <label className="form-label">Name</label>
                        <input type="text" name="name" value={subjectAdd?.name} onChange={handleChange} className="form-control" />
                      </div>
                      <div className="mb-3">
                        <label className="form-label">sortOrder</label>
                        <input type="number" name="sortOrder" value={subjectAdd?.sortOrder} onChange={handleChange} className="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="modal-footer">
                  ...
                  <button type="submit" disabled={isSave || subjectAdd?.name === "" || subjectAdd?.sortOrder === null} data-bs-dismiss="modal" className="btn btn-primary">
                    {isSave ? "Saving..." : "Save"}
                  </button>
                </div>
              </form>
