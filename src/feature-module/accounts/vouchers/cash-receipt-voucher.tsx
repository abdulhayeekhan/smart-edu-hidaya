...
const CashReceiptVoucher = () => {
    const [voucherTypeId, setVoucherTypeId] = useState(4) // cash receipt voucher
    ...
    const hasPermission = usePermission("Cash Receipt Voucher");
    ...
    // 🔥 Auto-set default Debit Account (Cash) when accounts list loads
    useEffect(() => {
                ...
                <div className="content">
                    ...
                    <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
                        <div className="my-auto mb-2">
                            <h3 className="page-title mb-1">Cash Receipt Voucher</h3>
                            <nav>
                    ...
                    <div className="card">
                        <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                            <h4 className="mb-3">Cash Receipt Voucher List</h4>
                ...
                <div className="modal-dialog modal-dialog-centered modal-xl">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Add Cash Receipt Voucher</h4>
                            <button
                                type="button"
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="mb-3">
                                                    <label className="form-label">Cash Account (Dr)</label>
                                                    <CommonSelect2
                                                        className="select"
                                                        options={banks}
