...
import { GetChartOfAccount } from "../../store/apps/ho-coa";
...
const HOOpenningBalance = () => {
    ...
    useEffect(() => {
        if (!selectedFinancialYear || !selectedFinancialYear.value) {
            setDataSource([]);
            return;
        }
        ...
        if (selectedRegion && selectedRegion.value) {
            endpoint = `${baseURL}/api/HOOBV/GetAllByCampusId?campusId=${selectedRegion.value}&financialYearId=${selectedFinancialYear.value}`;
        } else {
            endpoint = `${baseURL}/api/HOOBV/GetByFinancialYear?id=${selectedFinancialYear.value}`;
        }
    ...
    }, [selectedFinancialYear, selectedRegion]);
    ...
    const handleSave = () => {
        ...
        setLoading(true);
        axios
            .post(`${baseURL}/api/HOOBV/AddOpening`, dataSource)
            .then((res) => {
                ...
                <div className="content">
                    ...
                    <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
                        <div className="my-auto mb-2">
                            <h3 className="page-title mb-1">Openning Balance</h3>
                            <nav>
                    ...
                    <div className="card">
                        <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                            <h4 className="mb-3">Openning Balance</h4>
                                    ...
                                    <div className="dropdown-menu drop-width">
                                        <form>
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <CommonSelect3
                                                                className="select"
                                                                options={regionsList}
                                                                onChange={(option: any) => setSelectedRegion(option)}
                                                                value={selectedRegion || (regionsList.length > 0 ? regionsList[0] : null)}
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="p-3 d-flex align-items-center justify-content-end">
                                                <Link to="#" className="btn btn-light me-3" onClick={() => { setSelectedFinancialYear(null); setSelectedRegion(null); }}>
                                                    Reset
                                                </Link>
                                                <button type="button" className="btn btn-primary" onClick={() => {/* already fetches */ }}>
                                                    Apply
                                                </button>
                                            </div>
                                        </form>
...
export default HOOpenningBalance;
